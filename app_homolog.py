...
# ==============================================================================
# 8. COMPONENTES VISUAIS — Importado de core/views.py (Fase 6)
# ==============================================================================
from core.views import (
    render_autonomia, render_health_badge, render_alerts,
    render_projection, _format_delta_html, render_kpi, render_intel,
    render_regra_503020, render_cat_breakdown, render_hist_summary,
    render_evolution_chart, render_budget_bars, render_pending_box,
    render_recent_context, render_empty_month, render_score,
    render_annual_strip, render_prev_comparison, render_aporte_meta,
    render_top_gastos, render_split_casal, render_divisao_casal,
    render_renda_chart, render_patrimonio_chart, render_yoy,
    render_cashflow_forecast, render_weekday_pattern, render_tag_summary,
    render_savings_rate, render_consistency, render_anomalies,
    render_calendar_heatmap, render_transaction_cards, render_metas,
    render_challenges,
)

# render_pending_banner permanece aqui (depende de generate_recorrentes → save_entry)
