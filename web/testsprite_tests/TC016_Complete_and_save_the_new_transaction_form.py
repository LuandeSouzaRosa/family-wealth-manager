...
async def run_test():
    ...
    try:
        ...
        # -> Type 'luan.teste@test.com' into the email field (index 7).
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Compra mercado e2e')]").nth(0).is_visible(), "Expected 'Compra mercado e2e' to be visible"
