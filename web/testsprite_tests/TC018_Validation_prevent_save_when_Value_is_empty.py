...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Extrato' (Transações) in the main navigation to open the transactions page so the 'Nova Transação' button can be clicked.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Value')]").nth(0).is_visible(), "Expected 'Value' to be visible"
