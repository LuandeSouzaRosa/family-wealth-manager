...
async def run_test():
    ...
    try:
        ...
        # -> Type fake.user@example.com into email (index 7), type wrong-password-123 into password (index 8), then click Entrar na Conta (index 9). After submission, verify the URL still contains "/login" and that an error message containing the text "invalid" is visible.
