...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password into the login form and click the 'Entrar na Conta' button (indexes 7, 8, and 9). After login, wait for dashboard-content to appear before proceeding to click 'Transações'.
