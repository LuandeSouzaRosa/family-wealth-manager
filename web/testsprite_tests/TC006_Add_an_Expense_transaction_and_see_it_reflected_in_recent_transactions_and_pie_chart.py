...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click 'Entrar na Conta' to log in.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Groceries E2E')]").nth(0).is_visible(), "Expected 'Groceries E2E' to be visible"
